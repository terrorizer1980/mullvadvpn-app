...
describe('Date helper', () => {
  it('should modify minutes', () => {
    ...
    const earlierDate = date.modifyMinutes(initialDate, -50);
    const laterDate = date.modifyMinutes(initialDate, 100);
  ...
  it('should modify hours', () => {
    const initialDate = new Date('2021-01-01 13:37:10');
    const earlierDate = date.modifyHours(initialDate, -50);
    const laterDate = date.modifyHours(initialDate, 100);
  ...
  it('should modify days', () => {
    const initialDate = new Date('2021-01-01 13:37:10');
    const earlierDate = date.modifyDays(initialDate, -50);
    const laterDate = date.modifyDays(initialDate, 100);
