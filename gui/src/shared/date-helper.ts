...
export function modifyMinutes(date: DateType, minutes: number): Date {
  const modifiedDate = new Date(date);
  modifiedDate.setMinutes(modifiedDate.getMinutes() + minutes);
  return modifiedDate;
}

export function modifyHours(date: DateType, hours: number): Date {
  const modifiedDate = new Date(date);
  modifiedDate.setHours(modifiedDate.getHours() + hours);
  return modifiedDate;
}

export function modifyDays(date: DateType, days: number): Date {
  const modifiedDate = new Date(date);
